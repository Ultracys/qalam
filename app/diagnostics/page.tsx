...
export default function DiagnosticsPage() {
  ...
  useEffect(() => {
    const frame = requestAnimationFrame(() => setCapabilities({ pointer: supportsPointerEvents(), touch: 'ontouchstart' in window, maxTouchPoints: navigator.maxTouchPoints || 0 }));
