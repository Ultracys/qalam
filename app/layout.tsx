...
export const metadata: Metadata = {
  ...
  description:
    'تدرّب على الخط العربي في لوحة رقمية أو تحدَّ نفسك في سباق قلم تفاعلي يقيس الدقة والسرعة، مع دعم ضغط القلم وتصدير PNG وSVG.',
  applicationName: 'قلم',
  authors: [{ name: 'قلم' }],
  creator: 'قلم',
  publisher: 'قلم',
  ...
  openGraph: {
    ...
    description:
      'اختر بين لوحة الخط العربي الحرة وسباق قلم تفاعلي يجمع بين دقة الكتابة والسرعة.',
  },
  twitter: {
    card: 'summary',
    title: 'قلم | لوحة مجانية للتدرب على الخط العربي',
    description:
      'لوحة عربية مجانية وسباق كتابة تفاعلي لاختبار دقة الخط وسرعته.',
  },
  robots: {
    index: true,
    follow: true,
